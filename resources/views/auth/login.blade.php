  ...
  <div class="flex flex-col min-h-screen">
    ...
    <div class="flex flex-col md:flex-row flex-grow login-container">
      ...
      <div class="w-full md:w-1/2 flex flex-col p-6">
        <!-- Logo -->
        <div class="mb-20">
          <a href="/shop"><img class="logo" src="{{ asset('assets/facullogo.svg') }}" alt="Logo"></a>
        </div>

        <!-- Login Form -->
        <div class="mt-16 max-w-md">
          <h2 class="text-3xl font-normal mb-2">Log-in</h2>
          <p class="text-sm mb-8">Don't have an account? <a href="{{ route('register') }}" class="underline">Register</a></p>
      ...
      <div class="hidden md:block md:w-1/2">
        <img src="{{ asset('assets/registerimg.png') }}" alt="Living room with yellow sunlight and pillows" class="w-full h-full object-cover">
      </div>
    </div>
